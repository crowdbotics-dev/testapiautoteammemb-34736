...
## Project Structure
    ...
    ├── testapiautoteammemb_34736  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_34736`
...
2. Clone this repo and `cd testapiautoteammemb_34736`
